...
from resonate.vad.VADModels import VADResult, VADState
...
class SileroVAD:
    ...
    def process(self, x: Union[np.ndarray, torch.Tensor], window_size: int = 512,
                on_progress: Optional[Callable[[float], None]] = None) -> List[VADResult]:
